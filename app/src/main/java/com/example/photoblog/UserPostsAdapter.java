...
public class UserPostsAdapter extends RecyclerView.Adapter<UserPostsAdapter.UserPostsViewHolder> {
    ...
    public UserPostsAdapter(List<Posts> mPostsList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final UserPostsAdapter.UserPostsViewHolder holder, int position) {
    ...
    public void setNoLikes(final UserPostsViewHolder holder, Posts p) {
